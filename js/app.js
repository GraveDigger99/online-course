(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".testimonials__slider")) new core(".team-block__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
                ...
                loop: true,
                navigation: {
                    prevEl: ".controll__prev_team-block",
                    nextEl: ".controll__next_team-block"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".testimonials__slider")) new core(".testimonials__slider", {
                ...
                navigation: {
                    prevEl: ".controll__prev_testimonials",
                    nextEl: ".controll__next_testimonials"
                },
                on: {}
            });
        }
        ...
        function digitsCounter() {
            ...
            function digitsCountersAnimate(digitsCounter) {
                ...
                const duration = parseInt(digitsCounter.dataset.digitsCounterSpeed) ? parseInt(digitsCounter.dataset.digitsCounterSpeed) : 2e3;
